    ...
    <div class="layout">
        <div class="main">
            <div class="section__head">
                ...
                <h1 class="section__title" style="font-size:1rem;">{{ $heading }}</h1>
                    ...
                    @foreach ($articles as $a)
                        <article class="story">
                            ...
                            <div class="story__body">
                                ...
                                <p class="story__meta">
                                    <time>{{ format_tanggal($a['article_date'] ?? '', 'ins') }}</time>
            ...
            @else
                <div class="empty"><h3>Belum ada artikel</h3><p>Belum ada artikel pada bagian ini.</p></div>
            @endif
