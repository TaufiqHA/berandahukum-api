...
<div class="home">
    ...
    {{-- Tile banner: di mobile tampil tepat setelah pembatas # --}}
    ...
    {{-- Kartu kategori: di mobile tampil setelah tile banner --}}
